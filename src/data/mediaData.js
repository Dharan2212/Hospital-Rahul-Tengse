...
export const mediaData = [
  {
    ...
    date: '2025',
    summary: 'Coverage of a kidney health awareness initiative by Dr. Rahul Bhaskarrao Tengse for community education on kidney disease prevention.',
    alt: 'Newspaper coverage of kidney awareness programme — Dr. Rahul Bhaskarrao Tengse, Parbhani',
    thumbnail: media1,
    fullImage: media1,
  ...
  },
  {
    ...
    alt: 'Newspaper coverage of dialysis care awareness — Dr. Rahul Bhaskarrao Tengse, Parbhani',
    thumbnail: media2,
    fullImage: media2,
    approvalStatus: 'approved',
    privacyStatus: 'clear',
